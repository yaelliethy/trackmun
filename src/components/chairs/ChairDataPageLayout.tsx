...
export interface ChairDataPageLayoutProps {
  title: string
  description: string
...
export function ChairDataPageLayout({
  title,
  description,
  breadcrumbCurrent,
  totalCount,
        ...
        <BreadcrumbList>
          <BreadcrumbItem>
            <BreadcrumbLink asChild>
              <Link to="/chairs/assigned" className="text-muted-foreground hover:text-foreground transition-colors">
                Chair
              </Link>
            </BreadcrumbLink>
          </BreadcrumbItem>
